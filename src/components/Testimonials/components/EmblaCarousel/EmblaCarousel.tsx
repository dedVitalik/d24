  ...
  return (
    <div className="embla relative overflow-hidden pt-16">
      ...
      <div className='absolute right-0 top-0'>
        <button className="embla__prev mr-1  inline-block h-full  rounded p-0 transition-all duration-500 hover:bg-neutral-400" onClick={scrollPrev} type="button" >
        ...
        <button className="embla__next inline-block rounded p-0 transition-all duration-500 hover:bg-neutral-400" onClick={scrollNext} type="button">
          <span className='inline-block px-4 pb-3 pt-4 transition-all duration-500 [&>svg]:size-4 [&>svg]:fill-zinc-800 [&>svg]:hover:fill-white '>
            <svg viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
